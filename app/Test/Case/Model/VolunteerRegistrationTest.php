<?php
App::uses('VolunteerRegistration', 'Model');

/**
 * VolunteerRegistration Test Case
 *
 */
class VolunteerRegistrationTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->VolunteerRegistration = ClassRegistry::init('VolunteerRegistration');
	}
