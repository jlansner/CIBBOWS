...
<?php echo $this->Form->create('TestSwimRegistration'); ?>
	<fieldset>
		<legend><?php echo __('Edit Test Swim Registration'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TestSwimRegistration.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('TestSwimRegistration.id'))); ?></li>
