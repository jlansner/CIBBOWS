...
<?php echo $this->Form->create('VolunteerRegistration'); ?>
	<fieldset>
		<legend><?php echo __('Edit Volunteer Registration'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('VolunteerRegistration.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('VolunteerRegistration.id'))); ?></li>
