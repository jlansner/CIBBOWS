<div class="qualifyingRaces view">
<h2><?php  echo __('Qualifying Race'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($qualifyingRace['QualifyingRace']['id']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($qualifyingRace['QualifyingRace']['title']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Date'); ?></dt>
		<dd>
			<?php echo h($qualifyingRace['QualifyingRace']['date']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Url'); ?></dt>
		<dd>
			<?php echo h($qualifyingRace['QualifyingRace']['url']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Distance'); ?></dt>
		<dd>
			<?php echo h($qualifyingRace['QualifyingRace']['distance_number']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Distance'); ?></dt>
		<dd>
			<?php echo $this->Html->link($qualifyingRace['Distance']['id'], array('controller' => 'distances', 'action' => 'view', $qualifyingRace['Distance']['id'])); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Meters'); ?></dt>
		<dd>
			<?php echo h($qualifyingRace['QualifyingRace']['meters']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Approved'); ?></dt>
		<dd>
			<?php echo h($qualifyingRace['QualifyingRace']['approved']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($qualifyingRace['QualifyingRace']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($qualifyingRace['QualifyingRace']['modified']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Qualifying Race'), array('action' => 'edit', $qualifyingRace['QualifyingRace']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Qualifying Race'), array('action' => 'delete', $qualifyingRace['QualifyingRace']['id']), null, __('Are you sure you want to delete # %s?', $qualifyingRace['QualifyingRace']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Qualifying Races'), array('action' => 'index')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($qualifyingRace['ClinicRegistration'])): ?>
	...
	<?php
		$i = 0;
		foreach ($qualifyingRace['ClinicRegistration'] as $clinicRegistration): ?>
		<tr>
...
<div class="related">
	...
	<?php if (!empty($qualifyingRace['RaceRegistration'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
		<th><?php echo __('User Id'); ?></th>
	...
	<?php
		$i = 0;
		foreach ($qualifyingRace['RaceRegistration'] as $raceRegistration): ?>
		<tr>
...
<div class="related">
	...
	<?php if (!empty($qualifyingRace['TestSwimRegistration'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
		<th><?php echo __('User Id'); ?></th>
	...
	<?php
		$i = 0;
		foreach ($qualifyingRace['TestSwimRegistration'] as $testSwimRegistration): ?>
		<tr>
