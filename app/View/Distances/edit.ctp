<div class="distances form">
<?php echo $this->Form->create('Distance'); ?>
	<fieldset>
		<legend><?php echo __('Edit Distance'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Distance.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Distance.id'))); ?></li>
