...
<?php echo $this->Form->create('QualifyingSwim'); ?>
	<fieldset>
		<legend><?php echo __('Edit Qualifying Swim'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('QualifyingSwim.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('QualifyingSwim.id'))); ?></li>
