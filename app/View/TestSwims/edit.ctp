...
<?php echo $this->Form->create('TestSwim'); ?>
	<fieldset>
		<legend><?php echo __('Edit Test Swim'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TestSwim.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('TestSwim.id'))); ?></li>
